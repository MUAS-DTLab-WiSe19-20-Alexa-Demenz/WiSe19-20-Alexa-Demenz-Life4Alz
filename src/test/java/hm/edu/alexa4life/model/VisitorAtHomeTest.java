...
import hm.edu.life4alz.model.appointmenttypes.VisitorAtHome;

public class VisitorAtHomeTest {

	@Test
	public void validateSettersAndGetters() throws Exception {

		PojoClass activityPojo = PojoClassFactory.getPojoClass(VisitorAtHome.class);
